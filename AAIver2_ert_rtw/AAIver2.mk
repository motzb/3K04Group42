###########################################################################
## Makefile generated for component 'AAIver2'. 
## 
## Makefile     : AAIver2.mk
## Generated on : Mon Oct 17 16:27:25 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/AAIver2.elf
...
PRODUCT_NAME              = AAIver2
MAKEFILE                  = AAIver2.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2022a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2022a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/kemij/ONEDRI~1/THIRDY~1/1STSEM~1/SFWR3K~1/ASSIGN~1/3K04GR~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = AAIver2_comp.rsp
CMD_FILE                  = AAIver2.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/AAIver2.elf
...
DEFINES_STANDARD = -DMODEL=AAIver2 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o mw_sdk_interface.o MW_PWM.o AAIver2.o AAIver2_data.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
%.o : $(START_DIR)/AAIver2_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/AAIver2_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/AAIver2_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/AAIver2_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/AAIver2_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/AAIver2_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


AAIver2.o : $(START_DIR)/AAIver2_ert_rtw/AAIver2.c
	$(CC) $(CFLAGS) -o "$@" "$<"


AAIver2_data.o : $(START_DIR)/AAIver2_ert_rtw/AAIver2_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
